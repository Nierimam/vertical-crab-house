          ...
          <div class="col-lg-12">
                <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="nama" class="form-control form-control-sm" placeholder="Masukkan nama voucher" value="{{ $voucher->nama }}" required readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <label class="form-label">Tipe Voucher</label>
                        <select type="text" name="type" class="form-control form-control-sm bg-white" value="" required id="select-type" @readonly(true) disabled>
                    ...
                    <div class="col-lg-6" id="persentaseBody">
                        <div>
                            ...
                            <input type="text" name="persentase" class="form-control form-control-sm" placeholder="Masukkan persentase voucher" value="{{ $voucher->persentase }}" required readonly >
                        </div>
                    </div>
                    <div class="col-lg-6 d-none" id="nominalBody">
                        <div>
                            <label class="form-label">Nominal</label>
                            <input type="text" name="nominal" class="form-control form-control-sm" placeholder="Masukkan nominal voucher" value="{{ $voucher->nominal }}" required readonly >
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-lg-8">
                        ...
                        <input type="date" name="berlaku_sampai" class="form-control form-control-sm" placeholder="Masukkan tanggal berlaku voucher" value="{{ date('Y-m-d',strtotime($voucher->berlaku_sampai)) }}" required readonly>
                    </div>
                    <div class="col-lg-4">
                        <label class="form-label">Jumlah</label>
                        <input type="text" name="jumlah" class="form-control form-control-sm" placeholder="Masukkan jumlah voucher" value="{{ $voucher->jumlah }}" required readonly >
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-lg-12">
                ...
                <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <textarea type="text" name="deskripsi" class="form-control form-control-sm" rows="5" placeholder="Masukkan jumlah voucher" value="" required readonly >{{ $voucher->deskripsi }}</textarea>
                    </div>
                </div>
          </div>
        </form>
