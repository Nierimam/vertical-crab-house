...
<div class="card">
  <div class="card-body">
    <div class="d-flex align-items-center mb-3">
       <h5 class="mb-0" style="color: #cc2514">Data List Blog </h5>
    </div>
    <div class="d-flex justify-content-between align-items-center" >
      ...
      <div>
        <a href="{{route('blog.create')}}" class="top-menu mb-2 btn btn-sm text-light" style="background-color: #cc2514">
        ...
        <thead class="table-light">
         ...
         <tbody>
             ...
             <tr>
                 ...
                 <td>{{ ucfirst($blog->judul) }}</td>
                 <td>{{ ucfirst($blog->status) }}</td>
                 <td>
                     <div class="d-flex justify-content-center">
                         <div class="btn-group btn-group-sm">
                             <a class="btn btn-warning" style="color: white" href="{{ route('blog.edit', $blog->id) }}"> Edit </a>
                             <a class="btn btn-info" style="color: white" href="{{ route('blog.show',$blog->id) }}"> Detail </a>
                             <button type="button" class="btn btn-danger delete-data" data-redirect="{{route('blog.destroy',$blog->id)}}" data-id="{{ $blog->id }}" data-token="{{ csrf_token() }}"> Hapus </button>
                         </div>
                     </div>
                 </td>
             </tr>
             ...
             @else
             <tr>
                 <td class="text-center" colspan="6">Tidak Terdapat Data Blog</td>
             </tr>
             @endif
         </tbody>
        </table>
